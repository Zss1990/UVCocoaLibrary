 ...
 *  @return CGFloat
 */
#define UV_SCREEN_HEIGHT CGRectGetHeight([UIScreen mainScreen].bounds)
/**
 *  当前屏幕高度，相对iphone6的高度的比例
 *
 *  @return CGFloat
 */
#define UV_SCALE_IPHONE6_HEIGHT (CGRectGetHeight([UIScreen mainScreen].bounds) / 667.0)
