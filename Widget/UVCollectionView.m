...
@interface UVCollectionView ()

@end
@implementation UVCollectionView

- (void)initData
{
    _status = UV_COLLECTION_VIEW_STATUS_IDLE;
...
- (BOOL)emptyDataByTableview
{
    ...
    if(sections > 0)
    {
        ...
        {
            row = [self.dataSource collectionView:self numberOfItemsInSection:0];
        }
    }
