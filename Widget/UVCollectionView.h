 ...
 */
typedef void (^statusCollectionViewClickListener)(UVCollectionView *tableView, UV_COLLECTION_VIEW_STATUS status);
 ...
 *  视图点击事件
 */
@property (nonatomic,strong) statusCollectionViewClickListener errorViewClickEvent;
/**
 *  标记状态  由用户自行控制
 */
